...
./covid19_model sample data file=codid19_model.data.R init=covid19_model.init.R output file=sampling.csv
```
...
ggplot() +
  ...
  theme(axis.title.x=element_blank(),
        axis.title.y=element_blank()) +
  geom_vline(xintercept = as.POSIXct("2020-03-27")) +
  ylim(c(0,13))
```
